...
namespace Kent.Boogaart.KBCsv
{
 ...
 Encoding.UTF8;
        ...
        /// </summary>
        public static readonly string DefaultTableName = "TableModule";
#endif
        ...
        public HeaderRecord HeaderRecord
        {
            ...
            set
            {
                ...
                if(_headerRecord != null || _parser.PassedFirstRecord)
                    throw new Exception();
        ...
        /// ensure that the first record of CSV data is treated as a header record. AfterInit making a successful call to this method, the header record is
